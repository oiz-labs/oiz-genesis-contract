...
def generate_governor(
    ...
    replace_parameter(
        contract, "uint256 private constant PROPOSE_START_GOVOIZ_SUPPLY_THRESHOLD", f"{propose_start_threshold}"
    )
    replace_parameter(
...
def generate_system():
    ...
    replace_parameter(contract, "uint16 public constant oizChainID", f"0x{hex_chain_id}")
...
@main.command(help="Generate contracts for OIZ mainnet")
def mainnet():
    ...
    source_chain_id = "OIZ-Chain-Tigris"
...
@main.command(help="Generate contracts for OIZ testnet")
def testnet():
    global network, chain_id, hex_chain_id
    network = "testnet"
    chain_id = 97
    ...
    source_chain_id = "OIZ-Chain-Ganges"
...
def dev(
    ...
    init_burn_ratio: Annotated[str, typer.Option(help="init burn ratio of OizValidatorSet")] = "1000",
    source_chain_id: Annotated[
        str, typer.Option(help="source chain id of the token recover portal")] = "OIZ-Chain-Ganges",
    stake_hub_protector: Annotated[str, typer.Option(help="assetProtector of StakeHub")] = "address(0xdEaD)",
    governor_protector: Annotated[str, typer.Option(help="governorProtector of OIZGovernor")] = "address(0xdEaD)",
    ...
    init_voting_delay: Annotated[str,
                                 typer.Option(help="INIT_VOTING_DELAY of OIZGovernor")] = "0 hours / BLOCK_INTERVAL",
    init_voting_period: Annotated[str,
                                  typer.Option(help="INIT_VOTING_PERIOD of OIZGovernor")] = "7 days / BLOCK_INTERVAL",
    init_proposal_threshold: Annotated[str, typer.Option(help="INIT_PROPOSAL_THRESHOLD of OIZGovernor")] = "200 ether",
    init_quorum_numerator: Annotated[str, typer.Option(help="INIT_QUORUM_NUMERATOR of OIZGovernor")] = "10",
    propose_start_threshold: Annotated[
        str, typer.Option(help="PROPOSE_START_GOVOIZ_SUPPLY_THRESHOLD of OIZGovernor")] = "10_000_000 ether",
    init_min_period_after_quorum: Annotated[
        str, typer.Option(help="INIT_MIN_PERIOD_AFTER_QUORUM of OIZGovernor")] = "uint64(1 days / BLOCK_INTERVAL)",
    init_minimal_delay: Annotated[str, typer.Option(help="INIT_MINIMAL_DELAY of OIZTimelock")] = "24 hours",
